...
import httpx
>>>>>>> e76971b42dc82eab40e106d1f89adc9df3696484
...
async def formalize_statement(
    ...
    (2) Run lean_search and lean_loogle tools to see if the theorem statement is already written or similar theorems exist
    (3) Formalize the query into a Lean theorem statement
    (4) Run lean_write_file tool to write the imports and theorem statement to the file: {file_path}
    (5) Run lean_diagnostic_messages tool on the file {file_path} to check the current state  

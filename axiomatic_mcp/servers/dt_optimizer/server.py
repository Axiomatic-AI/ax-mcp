...
async def optimize_digital_twin_model(
    ...
    output_data: Annotated[list, "Output data: [{'name': 'transmission', 'unit': 'dimensionless', 'magnitudes': [0.8, 0.6, ...]}]"],
